...
<head>
    ...
    <title>TurboCare Configuration</title>
</head>
<body>
 	<DIV class="big_text_1">TurboCare Configuration
		<DIV class="big_text_2">Menu</DIV>
			<div style="width:80%; left:10px; position:relative; font-size:14px" class="divtable">
				...
				<div class="row">
					<div style="text-align: left" class="clear"><a href="RoomsEditor">Rooms and Beds</a></div>
					<div style="text-align: left" class="clear">
