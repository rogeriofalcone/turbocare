...
<head>
    ...
    <title>${getattr(self,'title','Vendor Groups Editor')}</title>
    ...
    <SCRIPT SRC="/static/javascript/config_VendorGroupsEditor.js" TYPE="text/javascript"></SCRIPT>
...
<body>
	<DIV style="position:relative; width:100%; left:0px; font-size:12px" class="divtable">
		<div class="row">
			...
			<div>
				<form name='VendorGroupsEditorForm' action="VendorGroupsEditorSave" method="post">
