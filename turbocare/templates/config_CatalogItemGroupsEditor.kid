...
<head>
    ...
    <title>${getattr(self,'title','Item Master Groups Editor')}</title>
    ...
    <SCRIPT SRC="/static/javascript/config_CatalogItemGroupsEditor.js" TYPE="text/javascript"></SCRIPT>
...
<body>
	<DIV style="position:relative; width:100%; left:0px; font-size:12px" class="divtable">
		<div class="row">
			...
			<div>
				<form name='CatalogItemGroupsEditorForm' action="CatalogItemGroupsEditorSave" method="post">
