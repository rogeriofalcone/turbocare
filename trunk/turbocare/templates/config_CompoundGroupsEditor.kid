...
<head>
    ...
    <title>${getattr(self,'title','Compound Groups Editor')}</title>
    ...
    <SCRIPT SRC="/static/javascript/config_CompoundGroupsEditor.js" TYPE="text/javascript"></SCRIPT>
...
<body>
	<DIV style="position:relative; width:100%; left:0px; font-size:12px" class="divtable">
		<div class="row">
			...
			<div>
				<form name='CompoundGroupsEditorForm' action="CompoundGroupsEditorSave" method="post">
