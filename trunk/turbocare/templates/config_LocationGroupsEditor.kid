...
<head>
    ...
    <title>${getattr(self,'title','Location Groups Editor')}</title>
    ...
    <SCRIPT SRC="/static/javascript/config_LocationGroupsEditor.js" TYPE="text/javascript"></SCRIPT>
...
<body>
	<DIV style="position:relative; width:100%; left:0px; font-size:12px" class="divtable">
		<div class="row">
			...
			<div>
				<form name='LocationGroupsEditorForm' action="LocationGroupsEditorSave" method="post">
